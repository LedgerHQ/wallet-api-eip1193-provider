...
class WalletAPIClient extends wallet_api_core_1.RpcNode {
    ...
    async signTransaction(accountId, transaction, options) {
        ...
        const safeResults = wallet_api_core_1.schemaTransactionSign.result.parse(transactionSignResult);
    ...
    async signTransactionAndBroadcast(accountId, transaction, options) {
        ...
        const safeResults = wallet_api_core_1.schemaTransactionSignAndBroadcast.result.parse(transactionSignResult);
    ...
    async signMessage(accountId, message) {
        ...
        const safeResults = wallet_api_core_1.schemaMessageSign.result.parse(messageSignResult);
    ...
    async listAccounts(params) {
        ...
        const safeResults = wallet_api_core_1.schemaAccountList.result.parse(listAccountsResult);
    ...
    async requestAccount(params) {
        ...
        const safeResults = wallet_api_core_1.schemaAccountRequest.result.parse(requestAccountsResult);
    ...
    async receive(accountId) {
        ...
        const safeResults = wallet_api_core_1.schemaAccountReceive.result.parse(receiveAccountsResult);
    ...
    async listCurrencies(params) {
        ...
        const safeResults = wallet_api_core_1.schemaCurrencyList.result.parse(listCurrenciesResult);
    ...
    async deviceTransport(params) {
        ...
        const safeResults = wallet_api_core_1.schemaDeviceTransport.result.parse(deviceTransportResult);
    ...
    async capabilities() {
        ...
        const safeResults = wallet_api_core_1.schemaWalletCapabilities.result.parse(walletCapabilitiesResult);
