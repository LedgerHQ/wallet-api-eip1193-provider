...
class TransportWalletAPI extends hw_transport_1.default {
    ...
    async exchange(apdu) {
        ...
        const safeResults = wallet_api_core_1.schemaDeviceExchange.result.parse(deviceExchangeResult);
    ...
    async close() {
        ...
        wallet_api_core_1.schemaDeviceClose.result.parse(deviceCloseResult);
