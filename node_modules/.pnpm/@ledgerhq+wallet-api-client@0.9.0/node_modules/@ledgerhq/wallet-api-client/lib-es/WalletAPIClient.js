...
import { deserializeAccount, Logger, RpcError, RpcErrorCode, RpcNode, schemaAccountList, schemaAccountReceive, schemaAccountRequest, schemaCurrencyList, schemaDeviceTransport, schemaMessageSign, schemaTransactionSign, schemaTransactionSignAndBroadcast, schemaWalletCapabilities, serializeTransaction, } from "@ledgerhq/wallet-api-core";
...
export class WalletAPIClient extends RpcNode {
    ...
    async signTransaction(accountId, transaction, options) {
        ...
        const safeResults = schemaTransactionSign.result.parse(transactionSignResult.result);
    ...
    async signTransactionAndBroadcast(accountId, transaction, options) {
        ...
        const safeResults = schemaTransactionSignAndBroadcast.result.parse(transactionSignResult.result);
    ...
    async signMessage(accountId, message) {
        ...
        const safeResults = schemaMessageSign.result.parse(messageSignResult.result);
    ...
    async listAccounts(params) {
        ...
        const safeResults = schemaAccountList.result.parse(listAccountsResult.result);
    ...
    async requestAccount(params) {
        ...
        const safeResults = schemaAccountRequest.result.parse(requestAccountsResult.result);
    ...
    async receive(accountId) {
        ...
        const safeResults = schemaAccountReceive.result.parse(receiveAccountsResult.result);
    ...
    async listCurrencies(params) {
        ...
        const safeResults = schemaCurrencyList.result.parse(listCurrenciesResult.result);
    ...
    async deviceTransport(params) {
        ...
        const safeResults = schemaDeviceTransport.result.parse(deviceTransportResult.result);
    ...
    async capabilities() {
        ...
        const safeResults = schemaWalletCapabilities.result.parse(walletCapabilitiesResult.result);
