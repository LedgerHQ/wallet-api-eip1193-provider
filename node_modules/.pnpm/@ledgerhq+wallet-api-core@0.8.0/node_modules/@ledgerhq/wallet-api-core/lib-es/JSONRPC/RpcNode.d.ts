...
import { RpcResponse, RpcRequest } from "./types";
...
export declare abstract class RpcNode<TSHandlers, TCHandlers> {
    ...
    private _request;
    private _notify;
    request<K extends keyof TCHandlers, TError = unknown>(method: K, params: MethodParamsIfExists<TCHandlers, K>): Promise<RpcResponse<ReturnTypeOfMethodIfExists<TCHandlers, K>, TError>>;
