 ...
 */
export declare type RpcResponse<TResult = unknown, TErrorData = unknown> = RpcResponseSuccess<TResult> | RpcResponseFailed<TErrorData>;
export interface RpcResponseSuccess<TResult = unknown> extends RpcResponseCommon {
    /**
...
export interface RpcResponseFailed<TErrorData = unknown> extends RpcResponseCommon {
    /**
