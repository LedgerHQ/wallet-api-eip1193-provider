const chainConfigs = [
  ...
  export function getChainConfigForCurrencyId(currencyId: string) {
  ...
  export function getChainConfigForChainId(chainId: number) {
  ...
  export function getSupportedCurrencyIds(): string[] {
